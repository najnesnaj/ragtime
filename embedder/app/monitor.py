...
model_path = os.path.abspath('/usr/local/models/paraphrase-multilingual-mpnet-base-v2')
...
class CustomEmbeddings(Embeddings):
    def __init__(self, model_path):
        ...
        #self.model = models.Transformer(model_path)
        self.model = SentenceTransformer(modules=[word_embedding_model, pooling_model])

    def embed_documents(self, texts):
        # Encode documents in batches for better performance
...
class PagesHandler(FileSystemEventHandler):
    def __init__(self, db_params):
        ...
        model_path = os.path.abspath('/usr/local/models/paraphrase-multilingual-mpnet-base-v2')
    #embeddings_model = CustomEmbeddings('./models/paraphrase-multilingual-mpnet-base-v2')
#        embeddings_model = CustomEmbeddings(model_path)
        self.model = CustomEmbeddings(model_path)

#SentenceTransformer('sentence-transformers/all-MiniLM-L6-v2')  # Initialize the SentenceTransformer model
